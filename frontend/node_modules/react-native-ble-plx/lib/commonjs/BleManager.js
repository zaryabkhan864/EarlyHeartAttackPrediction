...
class BleManager {
   ...
   */
  async destroy() {
    const response = await this._callPromise(_BleModule.BleModule.destroyClient());
  ...
  setLogLevel(logLevel) {
    return this._callPromise(_BleModule.BleModule.setLogLevel(logLevel));
  }
  ...
  cancelTransaction(transactionId) {
    return this._callPromise(_BleModule.BleModule.cancelTransaction(transactionId));
  }
  ...
  async startDeviceScan(UUIDs, options, listener) {
    ...
    return this._callPromise(_BleModule.BleModule.startDeviceScan(UUIDs, options));
  }
  ...
  stopDeviceScan() {
    ...
    return this._callPromise(_BleModule.BleModule.stopDeviceScan());
  }
  ...
  async connectToDevice(deviceIdentifier, options) {
    if (_reactNative.Platform.OS === 'android' && (await this.isDeviceConnected(deviceIdentifier))) {
  ...
  async discoverAllServicesAndCharacteristicsForDevice(deviceIdentifier, transactionId) {
    ...
    return new _Device.Device(device, this);
  }
  ...
  monitorCharacteristicForDevice(deviceIdentifier, serviceUUID, characteristicUUID, listener, transactionId, subscriptionType) {
    ...
    const args = _Utils.isIOS ? commonArgs : [...commonArgs, subscriptionType];
    return this._handleMonitorCharacteristic(_BleModule.BleModule.monitorCharacteristicForDevice(...args), filledTransactionId, listener);
  }
   ...
   * @private
   */
  _monitorCharacteristicForService(serviceIdentifier, characteristicUUID, listener, transactionId, subscriptionType) {
    const filledTransactionId = transactionId || this._nextUniqueID();
    const commonArgs = [serviceIdentifier, characteristicUUID, filledTransactionId];
    const args = _Utils.isIOS ? commonArgs : [...commonArgs, subscriptionType];
    return this._handleMonitorCharacteristic(_BleModule.BleModule.monitorCharacteristicForService(...args), filledTransactionId, listener);
  }
   ...
   * @private
   */
  _monitorCharacteristic(characteristicIdentifier, listener, transactionId, subscriptionType) {
    const filledTransactionId = transactionId || this._nextUniqueID();
    const commonArgs = [characteristicIdentifier, filledTransactionId];
    const args = _Utils.isIOS ? commonArgs : [...commonArgs, subscriptionType];
    return this._handleMonitorCharacteristic(_BleModule.BleModule.monitorCharacteristic(...args), filledTransactionId, listener);
  }
