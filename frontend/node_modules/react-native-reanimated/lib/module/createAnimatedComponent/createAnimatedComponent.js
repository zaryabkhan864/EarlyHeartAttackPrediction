...
export function createAnimatedComponent(Component, options) {
  ...
  class AnimatedComponent extends React.Component {
    ...
    _configureLayoutTransition() {
      ...
      updateLayoutAnimations(this.getComponentViewTag(), LayoutAnimationType.LAYOUT, maybeBuild(layout, undefined /* We don't have to warn user if style has common properties with animation for LAYOUT */, AnimatedComponent.displayName));
    }
